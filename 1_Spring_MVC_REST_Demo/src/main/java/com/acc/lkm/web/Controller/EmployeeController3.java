...
public class EmployeeController3 {
	...
	@RequestMapping(value = "/controller3/json/getDetails", method = RequestMethod.GET,produces=MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/controller3/xml/getDetails", method = RequestMethod.GET,produces=MediaType.APPLICATION_XML_VALUE)
